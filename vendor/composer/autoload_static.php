...
class ComposerStaticInit19b0974c8ed31292a8cd7bea470e26f5
{
    ...
    public static $classMap = array (
        ...
        'Game' => __DIR__ . '/../..' . '/models/Games.php',
        'GameManager' => __DIR__ . '/../..' . '/managers/GameManager.php',
        'PageController' => __DIR__ . '/../..' . '/controllers/PageController.php',
        'Player' => __DIR__ . '/../..' . '/models/Players.php',
        'PlayerManager' => __DIR__ . '/../..' . '/managers/PlayerManager.php',
        'PlayerPerformance' => __DIR__ . '/../..' . '/models/PlayerPerformance.php',
        'Player_PerformanceManager' => __DIR__ . '/../..' . '/managers/Player_PerformanceManager.php',
        'Router' => __DIR__ . '/../..' . '/services/Router.php',
        'Team' => __DIR__ . '/../..' . '/models/Teams.php',
        'TeamManager' => __DIR__ . '/../..' . '/managers/TeamManager.php',
    );
